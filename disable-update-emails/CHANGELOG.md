# CHANGELOG - Disable Update Notification Emails
...
- Unified update mechanism with GitHub API updater: Update URI: https://vladimir-ai.updates/disable-update-emails + ladimir-ai-updater.php.
