# CHANGELOG - Cyrillic & European to Latin SEO Transliteration
...
- Unified update mechanism with GitHub API updater: Update URI: https://vladimir-ai.updates/translit-cyr-lat + ladimir-ai-updater.php.
