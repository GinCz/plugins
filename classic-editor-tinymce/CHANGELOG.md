# CHANGELOG - Classic Editor & TinyMCE Advanced
...
- Unified update mechanism with GitHub API updater: Update URI: https://vladimir-ai.updates/classic-editor-tinymce + ladimir-ai-updater.php.
