# CHANGELOG - WooCommerce Auto SKU Generator & Search
...
- Unified update mechanism with GitHub API updater: Update URI: https://vladimir-ai.updates/wp-auto-sku + ladimir-ai-updater.php.
