# CHANGELOG - Allow HTML in Category & Taxonomy Descriptions
...
- Unified update mechanism with GitHub API updater: Update URI: https://vladimir-ai.updates/wp-allow-html-cats + ladimir-ai-updater.php.
