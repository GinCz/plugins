# CHANGELOG - Clean Head Meta & Anti-Fingerprint
...
- Unified update mechanism with GitHub API updater: Update URI: https://vladimir-ai.updates/clean-head-meta + ladimir-ai-updater.php.
